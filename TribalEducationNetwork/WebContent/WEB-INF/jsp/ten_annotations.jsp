<table style="width:100%">
	<tr><td style="width:40%">Date of annotation</td><td><div title="${'Date of annotation in YYYY-MM-DD format'}" ><input type="text" name="tenLearningObjectAnnotationsBean.date" value='<fmt:formatDate pattern="yyyy-MM-dd" value="${date}" />'/>  ?</div></td></tr>
	<tr><td>Format</td><td><div title="${'The physical or digital manifestation of the resource'}" ><input type="text" id="format" name="tenLearningObjectAnnotationsBean.format" value="${learningObjectDetailsBean.fileType}"/>  ?</div></td></tr>
	...
	<tr><td width='50%'>Annotator </td><td width='50%'><div title="${'Entity responsible for annotating the content'}" ><input type="text" name="tenLearningObjectAnnotationsBean.annotator" readonly value="${sessionScope.user_details.user_name}"/>  ?</div></td></tr>
